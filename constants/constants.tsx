export const onboardingSwiperData: onboardingSwiperDataType[] = [
    ...
    },
    {
        ...
        description: 'Create mobile apps with React Native and Tailwind CSS.',
        shortDescription: 'React Native, TypeScript',
        shortDescription2: 'Build cross-platform apps',
        image: require('@/assets/images/mobile-app.png')
    },
    {
        id: 4,
        title: 'Version Control',
        description: 'Understand the basics of Git and GitHub to manage workflow.',
        shortDescription: 'Git, GitHub',
        shortDescription2: 'Collaborate on code',
        image: require('@/assets/images/version-control.png')
    },
    {
        id: 5,
